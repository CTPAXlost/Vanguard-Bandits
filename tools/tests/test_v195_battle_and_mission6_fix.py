...
class V195BattleAndMission6FixTests(unittest.TestCase):
    ...
    def test_version(self):
        ...
        self.assertIn('config/version="1.9.11"', project)
        self.assertEqual(presets.count('application/file_version="1.9.11.0"'), 2)
        self.assertEqual(presets.count('application/product_version="1.9.11.0"'), 2)
